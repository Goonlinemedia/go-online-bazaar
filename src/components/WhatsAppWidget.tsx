...
const WhatsAppWidget = () => {
  ...
  const handleSend = (e: React.FormEvent) => {
    ...
    const url = `https://wa.me/${phoneNumber}?text=${escapedText}`;
    
    // Use location.href for better mobile redirection (safely trigger app)
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      <button
        ...
        className="w-12 h-12 sm:w-14 sm:h-14 bg-[#25D366] hover:bg-[#20b858] rounded-full text-white flex items-center justify-center shadow-xl transition-transform hover:scale-110 active:scale-95 z-50"
      >
        {isOpen ? (
